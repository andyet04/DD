<?php
	...
	$second_district = $_POST["second_district"];
	...
	$sql = "INSERT INTO favorite_power_color_lottle( number_1, number_2, number_3, number_4, number_5, number_6, second_district )
									VALUES( '$number_1', '$number_2', '$number_3', '$number_4', '$number_5','$number_6', '$second_district' )";
	//$sql = "INSERT INTO favorite_power_color_lotto( number_1, number_2, number_3, number_4, number_5, number_6, second_district )
									//VALUES( 1, 2, 3, 4, 5, 6, 888 )";
