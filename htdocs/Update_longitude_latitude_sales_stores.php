<?php
	...
	$sql = "Update sales_stores SET longitude = '$longitude', latitude = '$latitude' WHERE sell_address = '$sell_address' ";
	//$sql = "Update sales_stores SET longitude = 12.1 , latitude = 100.0 WHERE sell_address = '台北市中正區中華路二段107巷3號' ";
